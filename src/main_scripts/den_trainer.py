...
class DENTrainer:
    ...
    def __init__(self, data_loaders: (DataLoader, DataLoader, DataLoader),
        ...
        l2_coeff = self.penalty.l2_coeff if hasattr(self.penalty, "l2_coeff") else 0
        self.optimizer = optim.SGD(self.model.parameters(), lr=learning_rate, momentum=momentum, weight_decay=l2_coeff)
